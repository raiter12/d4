...
for (let i = 0 ; i < starWarsCharacters.length; i++){
   ...
   characters.push(personaggio.name);
...
let i = 0;
let massatot = 0;
while (i < starWarsCharacters.lonht){
  massatot = massatot + starWarsCharacters [i].mass;
  i++
}
...
break;
case massatot > 700 && masstot < 900:
console.log ("Warning: Load is over 700")
break;
case massatot > 900 && masstot < 1000:
